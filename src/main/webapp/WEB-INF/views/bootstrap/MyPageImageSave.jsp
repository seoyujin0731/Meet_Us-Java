	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-12 heading-section text-center ftco-animate">
				...
				<p class="jg" style="font-size: 30px;">My profile Image Add</p>
			</div>
		</div>
		<div class="row"></div>
	</div>
...
<!-- 				이미지 추가 -->
				<label for="title" style="font-size:1.5rem;"><strong>나의 프로필 사진 수정</strong></label>
				<p class="jg">*사진 저장시 이전의 사진은 자동으로 삭제 됩니다.</p>
				...
				<input type="button" value="완료" class="btn py-3 px-4 btn-primary" onclick="cencle_click()" style="margin-top:3rem; width:100%;background:#b2bbc9; border:#b2bbc9 !important;">
				</div>
		</div>
	</div>
